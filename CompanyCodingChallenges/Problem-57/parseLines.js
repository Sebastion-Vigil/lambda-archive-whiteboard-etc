// 2) [challenge-57] Parse Lines: Good morning! Here's your coding interview problem for today.

// This problem was asked by Amazon.

// Given a string s and an integer k, break up the string into multiple lines such that each line
//  has a length of k or less. You must break it up so that words don't break across lines. Each line
//   has to have the maximum possible amount of words. If there's no way to break the text up, then return null.
